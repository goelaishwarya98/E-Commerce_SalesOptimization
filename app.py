...
with tabs[4]:
    ...
    # Plotly bubble sizes cannot be negative. Some sub-categories have negative profit,
    # so use absolute profit as bubble size while keeping the signed profit on the y-axis context.
    driver["Bubble Size"] = driver["Profit"].abs() + 1
    fig = px.scatter(
        driver,
        ...
        hover_data={"Profit": ':,.2f', "Sales": ':,.2f', "Profit Margin %": ':.2f', "Bubble Size": False},
